...
from ml_service.drug.run_drug import predict_drug
app = Flask(__name__)
...
def drug():
    ...
    if form.validate_on_submit():
        ...
        session['result'] = predict_drug(session['age'], session['gender'], session['bp'], session['cholesterol'], session['na_to_k'])
